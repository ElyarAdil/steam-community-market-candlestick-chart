...
function onMouseMove(e) {
    ...
    h1_sold.innerText = "VOLUME: " + d[i * number_of_days_each_candlestick][2];
    td_high.innerText = "HIGH: ￥ " + hlco[i][0].toFixed(2);
    td_low.innerText = "LOW: ￥ " + hlco[i][1].toFixed(2);
    td_open.innerText = "OPEN: ￥ " + hlco[i][2].toFixed(2);
    td_close.innerText = "CLOSE: ￥ " + hlco[i][3].toFixed(2);
